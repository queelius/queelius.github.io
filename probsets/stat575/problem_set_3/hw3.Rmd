...
This is a problem set for STAT 575 - Computational Statistics at SIUe.
The problem set was given by Dr. Qiang Beidi, a professor in the Department of
Mathematics and Statistics at Southern Illinois University Edwardsville (SIUe).
It covers topics in numerical methods, simulation, and statistical computing.
These solutions are by Alex Towell, who was a graduate student in the course
during the Summer 2021 semester. He can be reached at
...
We see that the estimator $\hat{\pi}_{\mathrm{hermite}} = `r pi.hat.herm`$ with $n=10$ is a relatively poor estimator compared to $\hat{\pi}_{\mathrm{riemann}}$.
Let us find
$$
...
## Part (b)
Use iterated expectation and variance to find $E(X)$ and $\var(X)$ exactly.
