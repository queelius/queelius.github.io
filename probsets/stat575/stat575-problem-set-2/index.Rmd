...
This is a problem set for STAT 575 - Computational Statistics at SIUe. The problem set was given by Dr. Qiang Beidi, a professor in the Department of Mathematics and Statistics at Southern Illinois University Edwardsville (SIUe). It covers topics in numerical methods, simulation, and statistical computing. These solutions are by Alex Towell, who was a graduate student in the course during the Summer 2021 semester. He can be reached at [lex@metafunctor.com](mailto:lex@metafunctor.com)
...
We see that our estimate of $\theta$ is $\hat{\theta} = `r sol`$. (The $\theta$ before transforming it to the appropriate scale was $3.415283$.)
